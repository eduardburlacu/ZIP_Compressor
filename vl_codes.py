...
def shannon_fano(p):
    ...
    # Compute the cumulative probability distribution P_s
    ...
    for a in p: # for each probability
        ...
        for pos in range(length):
            ...
            # If it is larger than 1, you should also substract 1 from myf.
            codeword.append(int(myf)%2)
            myf -= ( int(myf)%2 )
