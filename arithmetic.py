...
def encode(x, p):
    ...
    for k in range(len(x)): # for every symbol
        ...
        # within the old interval [lo,hi], being careful to round 'inwards' so
        ...
        while True:
            if hi < half:
                ...
                lo = lo - half
                hi = hi - half        # substract half from lo and hi
                ...
                lo = lo - quarter
                hi = hi - quarter # subtract 'quarter' from lo and hi
            else:
